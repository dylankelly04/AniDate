...
import { Heart, Mail, Lock, Eye, EyeOff, User, Calendar, MapPin, FileText, CheckCircle } from "lucide-react";
...
export default function SignupPage() {
  ...
  const createUserProfile = async (userId: string) => {
    ...
    try {
      ...
      if (result.error) {
        ...
        throw new Error(`Profile operation failed: ${result.error.message || 'Unknown error'}`);
      }
      ...
      throw new Error(`Profile operation failed: ${err instanceof Error ? err.message : 'Unknown error'}`);
    }
  };
  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (authData.user) {
        console.log('User created successfully! Profile should be created automatically by trigger.');
          ...
          <CardContent className="pt-6 text-center">
            <CheckCircle className="w-16 h-16 text-green-500 mx-auto mb-4" />
                ...
                <p className="text-muted-foreground mb-4">
                  Welcome to AniDate! Your profile has been set up successfully. Redirecting you...
                </p>
      ...
      <Card className="w-full max-w-2xl relative z-10 backdrop-blur-sm bg-background/80 border-border/50">
        <CardHeader className="text-center">
          ...
          <div className="flex items-center justify-center gap-2 mt-4">
            ...
            <div className={`w-8 h-1 rounded-full ${currentStep >= 2 ? 'bg-primary' : 'bg-muted'}`} />
          ...
          {currentStep === 1 ? (
            ...
            <form onSubmit={handleSignup} className="space-y-4">
              ...
              <div className="flex gap-2">
                ...
                <Button type="submit" className="flex-1" disabled={loading || interests.length < 3}>
