...
export default function IncomingVideoCallPage() {
  ...
  const {
    ...
    matchId,
    userId: user?.id || '',
    autoAnswerIncoming: true, // Auto-answer since this is the incoming call page
    onCallEnded: () => {
          ...
          <div className="absolute inset-0 bg-black/50 flex items-center justify-center">
            <div className="text-center">
              ...
              <p className="text-white/80">
                {callState.isAnswering ? 'Joining call...' : 'Connecting...'}
              </p>
            </div>
          </div>
        )}
